...
SELECT city,branch, AVG(VAT) AS avg_vat FROM sales
GROUP BY city,branch
ORDER by avg_vat DESC;

-- Which customer type pays the most in VAT?
SELECT customer_type, AVG(VAT) AS avg_vat FROM sales
GROUP BY customer_type
ORDER by avg_vat DESC;
...
SELECT customer_type, COUNT(customer_type) AS cstm_ctn FROM sales
GROUP BY customer_type
ORDER BY cstm_ctn;
...
SELECT gender, COUNT(gender) AS total_gender FROM sales
GROUP BY gender
ORDER BY total_gender DESC;

-- What is the gender distribution per branch?
SELECT gender, COUNT(gender ) AS total_gender, branch FROM sales
GROUP BY branch, gender
ORDER BY branch;

-- Which time of the day do customers give most ratings?
SELECT time_of_date, COUNT(rating) AS ctn_rating FROM sales
GROUP BY time_of_date
ORDER BY ctn_rating DESC;

-- Which time of the day do customers give most ratings per branch?
SELECT time_of_date, branch, COUNT(rating) AS ctn_rating FROM sales
